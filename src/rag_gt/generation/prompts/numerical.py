"""Numerical intent: answer is a specific number, threshold, count, or formula."""
...
Intent: NUMERICAL — ask for a specific numeric value, threshold, count, rate, or formula stated in the facts.

Requirements:
- Output exactly one question.
- The answer must be a number, range, formula, or quantitative relationship.
- The number must appear in the provided facts — do not ask for derived calculations unless the derivation is shown in the facts.
